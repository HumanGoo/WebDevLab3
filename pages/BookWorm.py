...
if st.button("Give Me a Book!"):
    ...
    tags: {content}. Also prioritize books that are by {author}. After choosing the right book for me, start your response with "I reccommend this book: **(book title)** by (Author Name)". 
